...
parser.add_argument("-n" ,"--num_epochs", help = "Number of epochs", type = int)
...
if method in ["word2vec","glove"]:
    ...
    given_epochs = mains_args["num_epochs"]
    if given_epochs:
        num_epochs=given_epochs
    ...
    model,losses=train(model,train_data,optimizer,criterion)
    print("-----------------Training Good-----------------")
